...
int main(int argc, char **argv)
{
  ...
  int d = 5;
  //Hardcoded database
  product = new struct products[d];

  product[0].itemNumber = 1;
  strcpy( product[0].itemName, "Shovel");
  ...
  strcpy( product[1].itemName, "Aluminium ruler");
  ...
  strcpy( product[2].itemName, "Screwdriver");
  ...
  strcpy( product[3].itemName, "Utility knife");
  ...
  strcpy( product[4].itemName, "Steel hammer");
